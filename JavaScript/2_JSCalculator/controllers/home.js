...
module.exports = {
    ...
    indexPost: (req, res) => {
        ...
        // res.render('home/index', {'calculator.leftoperand':calculator.leftOperand,'calculator.rightOperand':calculator.rightOperand,'calculator.operator':calculator.operator, 'result':result})
    }
}